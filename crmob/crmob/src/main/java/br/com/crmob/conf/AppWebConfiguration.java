...
import br.com.crmob.controllers.LoginController;
...
public class AppWebConfiguration extends WebMvcConfigurerAdapter {
	...
	public InternalResourceViewResolver internalResourceViewResolver() {
		...
		// resolver.setExposeContextBeansAsAttributes(true);//faz com que todos
		// os beans fiquem disponíveis para as jsps
		// resolver.setExposedContextBeanNames("carrinhoCompras");//mesmo nome
		// da classe, mas com a inicial minúscula
		return resolver;
	}
	...
	public CacheManager cacheManager() {
		...
		return manager;
		// return new ConcurrentMapCacheManager(); utilizar apenas para
		// testes!!!!
	}
